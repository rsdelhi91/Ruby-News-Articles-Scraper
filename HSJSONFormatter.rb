# This class is used to format the RSS feed scraped from the Herald Sun into a valid 
# JSON format. The JSON library is used to convert the data stored in the article hash into 
...
class HSJSONFormatter < News::Formatter
