# This class is used to format the data scraped from the JSON source for New York Times
# into the CSV format for use by us. It performs the viable formatting required to
# attain the header, footer and its respective body in a valid CSV format, to be 
...
class NYTCSVFormatter < News::Formatter
