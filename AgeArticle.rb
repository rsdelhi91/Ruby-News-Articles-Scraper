...
# relating to data scraped from the RSS feed for The Age. When the scrape method in
# the AgeImporter is called, all the relevant data is stored in this hash for later
