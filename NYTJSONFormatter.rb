...
# JSON format. The JSON library is used to convert the data stored in the article hash 
# into JSON followed by some manual formatting to ensure a valid JSON format in the output 
# file. 
#
...
class NYTJSONFormatter < News::Formatter
	...
	# in the article hash for this source. When this function is called for the first 
